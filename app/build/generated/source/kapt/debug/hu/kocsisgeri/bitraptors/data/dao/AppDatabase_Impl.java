  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `person` (`id` INTEGER NOT NULL, `person_sex` TEXT NOT NULL, `person_age` INTEGER NOT NULL, `person_baseIllness` TEXT NOT NULL, PRIMARY KEY(`id`))");
        _db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, 'e552a9b2e234d79ff6c6469c54871bc0')");
      }
      ...
      protected RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        ...
        _columnsPerson.put("person_sex", new TableInfo.Column("person_sex", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsPerson.put("person_age", new TableInfo.Column("person_age", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsPerson.put("person_baseIllness", new TableInfo.Column("person_baseIllness", "TEXT", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (! _infoPerson.equals(_existingPerson)) {
          return new RoomOpenHelper.ValidationResult(false, "person(hu.kocsisgeri.bitraptors.data.dao.Person).\n"
                  + " Expected:\n" + _infoPerson + "\n"
                  + " Found:\n" + _existingPerson);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "e552a9b2e234d79ff6c6469c54871bc0", "af3ccef3b006943f55e2fab3b4b0314c");
